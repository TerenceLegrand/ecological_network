...
# ecological\_network <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/TerenceLegrand/ecological_network/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/TerenceLegrand/ecological_network/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/TerenceLegrand/ecological_network/tree/main/R):
...
Guidelines](https://github.com/TerenceLegrand/ecological_network/blob/main/CONTRIBUTING.md).
